...
class OptionsManager {
  ...
  async loadSettings() {
    ...
    document.getElementById("autoEnable").classList.toggle("active", settings.autoEnable !== false)
    document.getElementById("voiceAuthEnabled").classList.toggle("active", settings.voiceAuthEnabled !== false)
    document.getElementById("privacyMode").classList.toggle("active", settings.privacyMode === true)
    document.getElementById("debugMode").classList.toggle("active", settings.debugMode === true)
  ...
  bindEvents() {
    ...
    document.getElementById("autoEnable").addEventListener("click", (e) => {
      ...
      this.saveSetting("autoEnable", e.target.classList.contains("active"))
    })

    document.getElementById("voiceAuthEnabled").addEventListener("click", (e) => {
      e.target.classList.toggle("active")
      this.saveSetting("voiceAuthEnabled", e.target.classList.contains("active"))
    })

    document.getElementById("privacyMode").addEventListener("click", (e) => {
      e.target.classList.toggle("active")
      this.saveSetting("privacyMode", e.target.classList.contains("active"))
    })

    document.getElementById("debugMode").addEventListener("click", (e) => {
      e.target.classList.toggle("active")
      this.saveSetting("debugMode", e.target.classList.contains("active"))
    })
